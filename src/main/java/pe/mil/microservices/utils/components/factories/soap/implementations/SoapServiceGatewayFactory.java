...
import pe.mil.microservices.utils.components.helpers.soap.SoapKeyStoreHelper;
import pe.mil.microservices.utils.components.helpers.soap.SoapServiceHelper;
...
public class SoapServiceGatewayFactory {
    ...
    private WebServiceTemplate factoryWebServiceTemplate(final SoapMutualConfiguration mutual) {
        try {
            ...
            throw new SoapProcessException(e.getMessage(), ResponseCode.INTERNAL_SERVER_ERROR);
