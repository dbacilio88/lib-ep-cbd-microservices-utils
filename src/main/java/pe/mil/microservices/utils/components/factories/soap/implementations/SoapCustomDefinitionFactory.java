...
import pe.mil.microservices.utils.components.factories.soap.contracts.ISoapCustomDefinitionFactory;
...
public class SoapCustomDefinitionFactory implements ISoapCustomDefinitionFactory {
    ...
    public ISoapCustomDefinition factory(String customDefinitionId) {
        ...
        try {
            ...
            throw new SoapProcessException("error in SoapCustomDefinitionFactory, error in factory process", ResponseCode.INTERNAL_SERVER_ERROR);
        }
    }
}
